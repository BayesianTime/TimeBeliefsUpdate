...
te=squeeze(mean(bootBays.te,2));
tem=squeeze(mean(te,2));

tese=1.96*std(te,0,2)/sqrt(18);
...
%errorbar(x(1:3),tem(1:3),tese(1:3),'-o','linewidth',2,'Color',C(1,:), 'MarkerSize',5,...
%    'MarkerEdgeColor',C(1,:),'MarkerFaceColor',C(1,:));
hold on;

%errorbar(x(4:6),tem(4:6),tese(4:6),'-o','linewidth',2,'Color',C(1,:), 'MarkerSize',5,...
%    'MarkerEdgeColor',C(1,:),'MarkerFaceColor',C(1,:));
hold on;
...
%errorbar(x(1:3),tem(1:3),tese(1:3),'-o','linewidth',2,'Color',C(2,:), 'MarkerSize',5,...
%    'MarkerEdgeColor',C(2,:),'MarkerFaceColor',C(2,:));
hold on;

%errorbar(x(4:6),tem(4:6),tese(4:6),'-o','linewidth',2,'Color',C(2,:), 'MarkerSize',5,...
%    'MarkerEdgeColor',C(2,:),'MarkerFaceColor',C(2,:));
hold on;
